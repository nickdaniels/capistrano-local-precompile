  ...
  module LocalPrecompile
    ...
    def self.load_into(configuration)
      configuration.load do
        ...
        set(:precompile_cmd)   { "RAILS_ENV=#{rails_env.to_s.shellescape} #{asset_env} #{fetch(:bundle_cmd, "bundle")} exec rake assets:precompile" }
        set(:cleanexpired_cmd) { "RAILS_ENV=#{rails_env.to_s.shellescape} #{asset_env} #{fetch(:bundle_cmd, "bundle")} exec rake assets:clean_expired" }
